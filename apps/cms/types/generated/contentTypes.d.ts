...
export interface ApiAdPlacementAdPlacement extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'Emplacement publicitaire';
  ...
  attributes: {
    adUnitId: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    slot: Schema.Attribute.Enumeration<
      ['header', 'sidebar', 'in-article', 'footer', 'sticky-mobile']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Articles d'actualit\u00E9 Wab-infos";
    displayName: 'Article';
    pluralName: 'articles';
  ...
  attributes: {
    ...
    facebookPostedAt: Schema.Attribute.DateTime;
    ...
    readingTime: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<3>;
    ...
    xPostedAt: Schema.Attribute.DateTime;
  };
}
...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Journalistes et r\u00E9dacteurs';
    displayName: 'Auteur';
    pluralName: 'authors';
    singularName: 'author';
  };
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Rubriques \u00E9ditoriales';
  ...
  attributes: {
    articles: Schema.Attribute.Relation<'oneToMany', 'api::article.article'>;
    color: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#E63946'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    name: Schema.Attribute.String &
      ...
      Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
    secondaryArticles: Schema.Attribute.Relation<
      'manyToMany',
      'api::article.article'
    >;
    slug: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
...
export interface ApiEditorPushSubscriptionEditorPushSubscription
  extends Struct.CollectionTypeSchema {
  collectionName: 'editor_push_subscriptions';
  info: {
    displayName: 'Abonnement push r\u00E9daction';
    pluralName: 'editor-push-subscriptions';
    singularName: 'editor-push-subscription';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::editor-push-subscription.editor-push-subscription'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    apkBannerEnabled: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    apkBannerVisible: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    chrome: Schema.Attribute.JSON & Schema.Attribute.DefaultTo<{}>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    homepageSections: Schema.Attribute.JSON & Schema.Attribute.DefaultTo<[]>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    pwaBannerEnabled: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    pwaBannerVisible: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    showArticleViewCounts: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
...
export interface ApiVideoVideo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['live', 'replay', 'emission', 'podcast']
    > &
      Schema.Attribute.DefaultTo<'replay'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiYoutubePushLogYoutubePushLog
  extends Struct.CollectionTypeSchema {
