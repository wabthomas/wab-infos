...
/** Store externe : afficher un toast ne re-render pas toute l’app. */
  ...
  return (
    <div
      ...
      className={cn(
        ...
        'animate-[redaction-toast-in_0.28s_cubic-bezier(0.22,1,0.36,1)_both]',
        item.variant === 'success' &&
          'border-emerald-500/25 bg-card/95 text-foreground dark:border-emerald-400/30',
        item.variant === 'error' &&
          'border-red-500/30 bg-card/95 text-foreground dark:border-red-400/35',
    ...
    >
      <span
        className={cn(
          ...
          item.variant === 'success' && 'bg-emerald-500/15 text-emerald-600 dark:text-emerald-400',
          item.variant === 'error' && 'bg-red-500/15 text-red-600 dark:text-red-400',
